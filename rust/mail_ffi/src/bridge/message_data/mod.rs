...
//         let mut env = crate::bridge::jvm().env();
...
//         match value {
//             JValue::Object(obj) => {
//                 match Self::convert_java_string_to_rust_string(&env, JString::from(obj)) {
//                     Ok(s) => Some(s),
//                     Err(err) => {
//                         crate::warn!("{}", err);
//                         None
...
//     fn convert_java_string_to_rust_string(env: &JNIEnv, j_string: JString) -> Result<String> {
//         let j_string = env
//             .get_string(&j_string)

...
export namespace command {
    ...
    export class UpdateAccountRequest extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            imap_protocol?: ConnectProtocol;
            imap_server?: string;
            imap_port?: number;
            imap_account?: string;
            imap_password?: string;
            smtp_protocol?: ConnectProtocol;
            smtp_server?: string;
            smtp_port?: number;
            smtp_account?: string;
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("login_type" in data && data.login_type != undefined) {
                    this.login_type = data.login_type;
                }
            }
        }
        get imap_protocol() {
            return pb_1.Message.getFieldWithDefault(this, 1, ConnectProtocol.none) as ConnectProtocol;
        }
        set imap_protocol(value: ConnectProtocol) {
        ...
        get smtp_protocol() {
            return pb_1.Message.getFieldWithDefault(this, 6, ConnectProtocol.none) as ConnectProtocol;
        }
        set smtp_protocol(value: ConnectProtocol) {
        ...
        get login_type() {
            return pb_1.Message.getFieldWithDefault(this, 11, LoginType.password) as LoginType;
        }
        set login_type(value: LoginType) {
        ...
        static fromObject(data: {
            ...
            if (data.login_type != null) {
                message.login_type = data.login_type;
            }
            return message;
        }
        toObject() {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.imap_protocol != ConnectProtocol.none)
                writer.writeEnum(1, this.imap_protocol);
            if (this.imap_server.length)
                writer.writeString(2, this.imap_server);
            if (this.imap_port != 0)
                writer.writeInt32(3, this.imap_port);
            if (this.imap_account.length)
                writer.writeString(4, this.imap_account);
            if (this.imap_password.length)
                writer.writeString(5, this.imap_password);
            if (this.smtp_protocol != ConnectProtocol.none)
                writer.writeEnum(6, this.smtp_protocol);
            if (this.smtp_server.length)
                writer.writeString(7, this.smtp_server);
            if (this.smtp_port != 0)
                writer.writeInt32(8, this.smtp_port);
            if (this.smtp_account.length)
                writer.writeString(9, this.smtp_account);
            if (this.smtp_password.length)
                writer.writeString(10, this.smtp_password);
            if (this.login_type != LoginType.password)
                writer.writeEnum(11, this.login_type);
            if (!w)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 10:
                        ...
                        break;
                    case 11:
                        message.login_type = reader.readEnum();
                        break;
    ...
    export class MailLabel extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.unread_count != 0)
                writer.writeInt32(2, this.unread_count);
            if (this.total_count != 0)
                writer.writeInt32(3, this.total_count);
            if (this.is_system != false)
                writer.writeBool(4, this.is_system);
            if (!w)
                return writer.getResultBuffer();
        }

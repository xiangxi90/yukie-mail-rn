...
export namespace mail_base {
    ...
    export class MailAddress extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): MailAddress {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new MailAddress();
    ...
    export class Account extends pb_1.Message {
        ...
        get status() {
            return pb_1.Message.getFieldWithDefault(this, 2, AccountStatus.success) as AccountStatus;
        }
        ...
        get smtp_protocol() {
            return pb_1.Message.getFieldWithDefault(this, 7, MailProtocal.none) as MailProtocal;
        }
        ...
        get imap_protocol() {
            return pb_1.Message.getFieldWithDefault(this, 12, MailProtocal.none) as MailProtocal;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_mail_address)
                writer.writeMessage(1, this.mail_address, () => this.mail_address.serialize(writer));
            if (this.status != AccountStatus.success)
                writer.writeEnum(2, this.status);
            if (this.smtp_server.length)
                writer.writeString(3, this.smtp_server);
            if (this.smtp_account.length)
                writer.writeString(4, this.smtp_account);
            if (this.smtp_port != 0)
                writer.writeInt32(5, this.smtp_port);
            if (this.smtp_password.length)
                writer.writeString(6, this.smtp_password);
            if (this.smtp_protocol != MailProtocal.none)
                writer.writeEnum(7, this.smtp_protocol);
            if (this.imap_server.length)
                writer.writeString(8, this.imap_server);
            if (this.imap_port != 0)
                writer.writeInt32(9, this.imap_port);
            if (this.imap_account.length)
                writer.writeString(10, this.imap_account);
            if (this.imap_password.length)
                writer.writeString(11, this.imap_password);
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): Account {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.mail_address, () => message.mail_address = MailAddress.deserialize(reader));
                        break;
                    case 2:

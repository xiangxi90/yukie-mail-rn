...
export namespace command {
    ...
    export class UpdateAccountRequest extends pb_1.Message {
        ...
        get account() {
            return pb_1.Message.getWrapperField(this, dependency_1.mail_base.Account, 1) as dependency_1.mail_base.Account;
        }
        ...
        static fromObject(data: {
            account?: ReturnType<typeof dependency_1.mail_base.Account.prototype.toObject>;
        }): UpdateAccountRequest {
            const message = new UpdateAccountRequest({});
            if (data.account != null) {
                message.account = dependency_1.mail_base.Account.fromObject(data.account);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): UpdateAccountRequest {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.account, () => message.account = dependency_1.mail_base.Account.deserialize(reader));
                        break;
    ...
    export class GetAccountRequest extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.need_refresh != false)
                writer.writeBool(1, this.need_refresh);
            if (!w)
                return writer.getResultBuffer();
        }
    ...
    export class SendMailRequest extends pb_1.Message {
        ...
        get from() {
            return pb_1.Message.getWrapperField(this, dependency_1.mail_base.MailAddress, 2) as dependency_1.mail_base.MailAddress;
        }
        ...
        get to() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_1.mail_base.MailAddress, 3) as dependency_1.mail_base.MailAddress[];
        }
        set to(value: dependency_1.mail_base.MailAddress[]) {
            pb_1.Message.setRepeatedWrapperField(this, 3, value);
        }
        get cc() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_1.mail_base.MailAddress, 4) as dependency_1.mail_base.MailAddress[];
        }
        set cc(value: dependency_1.mail_base.MailAddress[]) {
            pb_1.Message.setRepeatedWrapperField(this, 4, value);
        }
        get bcc() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_1.mail_base.MailAddress, 5) as dependency_1.mail_base.MailAddress[];
        }
        ...
        static fromObject(data: {
            subject?: string;
            from?: ReturnType<typeof dependency_1.mail_base.MailAddress.prototype.toObject>;
            to?: ReturnType<typeof dependency_1.mail_base.MailAddress.prototype.toObject>[];
            cc?: ReturnType<typeof dependency_1.mail_base.MailAddress.prototype.toObject>[];
            bcc?: ReturnType<typeof dependency_1.mail_base.MailAddress.prototype.toObject>[];
            body?: string;
            deliver_time?: number;
        }): SendMailRequest {
            ...
            if (data.to != null) {
                message.to = data.to.map(item => dependency_1.mail_base.MailAddress.fromObject(item));
            }
            if (data.cc != null) {
                message.cc = data.cc.map(item => dependency_1.mail_base.MailAddress.fromObject(item));
            }
            if (data.bcc != null) {
                message.bcc = data.bcc.map(item => dependency_1.mail_base.MailAddress.fromObject(item));
            }
            if (data.body != null) {
        ...
        toObject() {
            ...
            if (this.to != null) {
                data.to = this.to.map((item: dependency_1.mail_base.MailAddress) => item.toObject());
            }
            if (this.cc != null) {
                data.cc = this.cc.map((item: dependency_1.mail_base.MailAddress) => item.toObject());
            }
            if (this.bcc != null) {
                data.bcc = this.bcc.map((item: dependency_1.mail_base.MailAddress) => item.toObject());
            }
            if (this.body != null) {
                data.body = this.body;
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.to.length)
                writer.writeRepeatedMessage(3, this.to, (item: dependency_1.mail_base.MailAddress) => item.serialize(writer));
            if (this.cc.length)
                writer.writeRepeatedMessage(4, this.cc, (item: dependency_1.mail_base.MailAddress) => item.serialize(writer));
            if (this.bcc.length)
                writer.writeRepeatedMessage(5, this.bcc, (item: dependency_1.mail_base.MailAddress) => item.serialize(writer));
            if (this.body.length)
                writer.writeString(6, this.body);
            if (this.deliver_time != 0)
                writer.writeInt64(7, this.deliver_time);
            if (!w)
                return writer.getResultBuffer();
        }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.from, () => message.from = dependency_1.mail_base.MailAddress.deserialize(reader));
                        break;
                    case 3:
                        reader.readMessage(message.to, () => pb_1.Message.addToRepeatedWrapperField(message, 3, dependency_1.mail_base.MailAddress.deserialize(reader), dependency_1.mail_base.MailAddress));
                        break;
                    case 4:
                        reader.readMessage(message.cc, () => pb_1.Message.addToRepeatedWrapperField(message, 4, dependency_1.mail_base.MailAddress.deserialize(reader), dependency_1.mail_base.MailAddress));
                        break;
                    case 5:
                        reader.readMessage(message.bcc, () => pb_1.Message.addToRepeatedWrapperField(message, 5, dependency_1.mail_base.MailAddress.deserialize(reader), dependency_1.mail_base.MailAddress));
                        break;
                    case 6:
    ...
    export class SendMailRespone extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): SendMailRespone {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new SendMailRespone();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class GetMailListRequest extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.last_uid.length)
                writer.writeString(2, this.last_uid);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetMailListRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new GetMailListRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class MessageInfo extends pb_1.Message {
        ...
        get from() {
            return pb_1.Message.getWrapperField(this, dependency_1.mail_base.MailAddress, 4) as dependency_1.mail_base.MailAddress;
        }
        set from(value: dependency_1.mail_base.MailAddress) {
        ...
        get cc() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_1.mail_base.MailAddress, 6) as dependency_1.mail_base.MailAddress[];
        }
        set cc(value: dependency_1.mail_base.MailAddress[]) {
            pb_1.Message.setRepeatedWrapperField(this, 6, value);
        }
        get bcc() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_1.mail_base.MailAddress, 7) as dependency_1.mail_base.MailAddress[];
        }
        set bcc(value: dependency_1.mail_base.MailAddress[]) {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.reply_to_id.length)
                writer.writeString(2, this.reply_to_id);
            if (this.subject.length)
                writer.writeString(3, this.subject);
            if (this.has_from)
                writer.writeMessage(4, this.from, () => this.from.serialize(writer));
            if (this.to.length)
                writer.writeRepeatedMessage(5, this.to, (item: dependency_1.mail_base.MailAddress) => item.serialize(writer));
            if (this.cc.length)
                writer.writeRepeatedMessage(6, this.cc, (item: dependency_1.mail_base.MailAddress) => item.serialize(writer));
            if (this.bcc.length)
                writer.writeRepeatedMessage(7, this.bcc, (item: dependency_1.mail_base.MailAddress) => item.serialize(writer));
            if (this.create_time != 0)
                writer.writeInt64(8, this.create_time);
            if (this.summary.length)
                writer.writeString(9, this.summary);
            if (this.flaged != false)
                writer.writeBool(10, this.flaged);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): MessageInfo {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new MessageInfo();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        reader.readMessage(message.to, () => pb_1.Message.addToRepeatedWrapperField(message, 5, dependency_1.mail_base.MailAddress.deserialize(reader), dependency_1.mail_base.MailAddress));
                        break;
                    case 6:
                        reader.readMessage(message.cc, () => pb_1.Message.addToRepeatedWrapperField(message, 6, dependency_1.mail_base.MailAddress.deserialize(reader), dependency_1.mail_base.MailAddress));
                        break;
                    case 7:
                        reader.readMessage(message.bcc, () => pb_1.Message.addToRepeatedWrapperField(message, 7, dependency_1.mail_base.MailAddress.deserialize(reader), dependency_1.mail_base.MailAddress));
                        break;
                    case 8:
    ...
    export class GetMailListResponse extends pb_1.Message {
        ...
        get message_info() {
            return pb_1.Message.getRepeatedWrapperField(this, MessageInfo, 3) as MessageInfo[];
        }
        ...
        static fromObject(data: {
            ...
            if (data.message_info != null) {
                message.message_info = data.message_info.map(item => MessageInfo.fromObject(item));
            }
        ...
        toObject() {
            ...
            if (this.message_info != null) {
                data.message_info = this.message_info.map((item: MessageInfo) => item.toObject());
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.message_count != 0)
                writer.writeInt32(1, this.message_count);
            if (this.last_uid.length)
                writer.writeString(2, this.last_uid);
            if (this.message_info.length)
                writer.writeRepeatedMessage(3, this.message_info, (item: MessageInfo) => item.serialize(writer));
            if (this.has_more != false)
                writer.writeBool(4, this.has_more);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetMailListResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new GetMailListResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        reader.readMessage(message.message_info, () => pb_1.Message.addToRepeatedWrapperField(message, 3, MessageInfo.deserialize(reader), MessageInfo));
                        break;
                    case 4:
    ...
    export class GetMailMessageRequest extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetMailMessageRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new GetMailMessageRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class MessageFull extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_message_info)
                writer.writeMessage(2, this.message_info, () => this.message_info.serialize(writer));
            if (this.body.length)
                writer.writeString(3, this.body);
            if (this.labels.length)
                writer.writeRepeatedString(4, this.labels);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): MessageFull {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new MessageFull();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.message_info, () => message.message_info = MessageInfo.deserialize(reader));
                        break;
                    case 3:
                        message.body = reader.readString();
                        break;
    ...
    export class GetMailMessageResponse extends pb_1.Message {
        ...
        get message_full() {
            return pb_1.Message.getRepeatedWrapperField(this, MessageFull, 1) as MessageFull[];
        }
        ...
        static fromObject(data: {
            ...
            if (data.message_full != null) {
                message.message_full = data.message_full.map(item => MessageFull.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.message_full != null) {
                data.message_full = this.message_full.map((item: MessageFull) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.message_full.length)
                writer.writeRepeatedMessage(1, this.message_full, (item: MessageFull) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetMailMessageResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new GetMailMessageResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.message_full, () => pb_1.Message.addToRepeatedWrapperField(message, 1, MessageFull.deserialize(reader), MessageFull));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class UpdateMailMessageRequest extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.add_label.length)
                writer.writeString(2, this.add_label);
            if (this.remove_label.length)
                writer.writeString(3, this.remove_label);
            if (this.is_move != false)
                writer.writeBool(4, this.is_move);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): UpdateMailMessageRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new UpdateMailMessageRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class UpdateMailMessageResponse extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): UpdateMailMessageResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new UpdateMailMessageResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class DeleteMailMessageRequest extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): DeleteMailMessageRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new DeleteMailMessageRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class DeleteMailMessageResponse extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): DeleteMailMessageResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new DeleteMailMessageResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class GetCalendarRequest extends pb_1.Message {
        ...
        get type() {
            return pb_1.Message.getFieldWithDefault(this, 1, CalendarEventType.all) as CalendarEventType;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.type != CalendarEventType.all)
                writer.writeEnum(1, this.type);
            if (this.years != 0)
                writer.writeInt32(2, this.years);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetCalendarRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new GetCalendarRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class CalendarEvent extends pb_1.Message {
        ...
        get type() {
            return pb_1.Message.getFieldWithDefault(this, 5, CalendarEventType.all) as CalendarEventType;
        }
        set type(value: CalendarEventType) {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): CalendarEvent {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new CalendarEvent();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class GetCalendarResponse extends pb_1.Message {
        ...
        get calander_event() {
            return pb_1.Message.getRepeatedWrapperField(this, CalendarEvent, 1) as CalendarEvent[];
        }
        ...
        static fromObject(data: {
            ...
            if (data.calander_event != null) {
                message.calander_event = data.calander_event.map(item => CalendarEvent.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.calander_event != null) {
                data.calander_event = this.calander_event.map((item: CalendarEvent) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.calander_event.length)
                writer.writeRepeatedMessage(1, this.calander_event, (item: CalendarEvent) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetCalendarResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new GetCalendarResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.calander_event, () => pb_1.Message.addToRepeatedWrapperField(message, 1, CalendarEvent.deserialize(reader), CalendarEvent));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class UpdateCalendarRequest extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): UpdateCalendarRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new UpdateCalendarRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class UpdateCalendarResponse extends pb_1.Message {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): UpdateCalendarResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new UpdateCalendarResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class GetMailLabelsRequest extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.labels.length)
                writer.writeRepeatedString(1, this.labels);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetMailLabelsRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new GetMailLabelsRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class MailLabel extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.label_id.length)
                writer.writeString(1, this.label_id);
            if (this.label_name.length)
                writer.writeString(2, this.label_name);
            if (this.unread_count != 0)
                writer.writeInt32(3, this.unread_count);
            if (this.total_count != 0)
                writer.writeInt32(4, this.total_count);
            if (this.is_system != false)
                writer.writeBool(5, this.is_system);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): MailLabel {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new MailLabel();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
    ...
    export class GetMailLabelResponse extends pb_1.Message {
        ...
        get labels() {
            return pb_1.Message.getRepeatedWrapperField(this, MailLabel, 1) as MailLabel[];
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.labels.length)
                writer.writeRepeatedMessage(1, this.labels, (item: MailLabel) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): GetMailLabelResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new GetMailLabelResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.labels, () => pb_1.Message.addToRepeatedWrapperField(message, 1, MailLabel.deserialize(reader), MailLabel));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export abstract class UnimplementedMessageServiceService {
        static definition = {
            GetMailLabels: {
                ...
                requestSerialize: (message: GetMailLabelsRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => GetMailLabelsRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: GetMailLabelResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => GetMailLabelResponse.deserialize(new Uint8Array(bytes))
            },
            GetMailList: {
                path: "/command.MessageService/GetMailList",
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: GetMailListRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => GetMailListRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: GetMailListResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => GetMailListResponse.deserialize(new Uint8Array(bytes))
            },
            GetMailMessage: {
                path: "/command.MessageService/GetMailMessage",
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: GetMailMessageRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => GetMailMessageRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: GetMailMessageResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => GetMailMessageResponse.deserialize(new Uint8Array(bytes))
            },
            SendMail: {
                ...
                responseSerialize: (message: SendMailRespone) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => SendMailRespone.deserialize(new Uint8Array(bytes))
            }
        };
        [method: string]: grpc_1.UntypedHandleCall;
        abstract GetMailLabels(call: grpc_1.ServerUnaryCall<GetMailLabelsRequest, GetMailLabelResponse>, callback: grpc_1.sendUnaryData<GetMailLabelResponse>): void;
        abstract GetMailList(call: grpc_1.ServerUnaryCall<GetMailListRequest, GetMailListResponse>, callback: grpc_1.sendUnaryData<GetMailListResponse>): void;
        abstract GetMailMessage(call: grpc_1.ServerUnaryCall<GetMailMessageRequest, GetMailMessageResponse>, callback: grpc_1.sendUnaryData<GetMailMessageResponse>): void;
        abstract SendMail(call: grpc_1.ServerUnaryCall<SendMailRequest, SendMailRespone>, callback: grpc_1.sendUnaryData<SendMailRespone>): void;
    }
    export class MessageServiceClient extends grpc_1.makeGenericClientConstructor(UnimplementedMessageServiceService.definition, "MessageService", {}) {
        ...
        GetMailLabels: GrpcUnaryServiceInterface<GetMailLabelsRequest, GetMailLabelResponse> = (message: GetMailLabelsRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<GetMailLabelResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<GetMailLabelResponse>, callback?: grpc_1.requestCallback<GetMailLabelResponse>): grpc_1.ClientUnaryCall => {
            return super.GetMailLabels(message, metadata, options, callback);
        };
        GetMailList: GrpcUnaryServiceInterface<GetMailListRequest, GetMailListResponse> = (message: GetMailListRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<GetMailListResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<GetMailListResponse>, callback?: grpc_1.requestCallback<GetMailListResponse>): grpc_1.ClientUnaryCall => {
            return super.GetMailList(message, metadata, options, callback);
        };
        GetMailMessage: GrpcUnaryServiceInterface<GetMailMessageRequest, GetMailMessageResponse> = (message: GetMailMessageRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<GetMailMessageResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<GetMailMessageResponse>, callback?: grpc_1.requestCallback<GetMailMessageResponse>): grpc_1.ClientUnaryCall => {
            return super.GetMailMessage(message, metadata, options, callback);
        };
        SendMail: GrpcUnaryServiceInterface<SendMailRequest, SendMailRespone> = (message: SendMailRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<SendMailRespone>, options?: grpc_1.CallOptions | grpc_1.requestCallback<SendMailRespone>, callback?: grpc_1.requestCallback<SendMailRespone>): grpc_1.ClientUnaryCall => {
    ...
    export class MailAccountClient extends grpc_1.makeGenericClientConstructor(UnimplementedMailAccountService.definition, "MailAccount", {}) {
        constructor(address: string, credentials: grpc_1.ChannelCredentials, options?: Partial<grpc_1.ChannelOptions>) {
            super(address, credentials, options);
        }
